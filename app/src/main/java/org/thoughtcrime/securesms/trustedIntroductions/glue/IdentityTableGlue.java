...
public interface IdentityTableGlue {
  ...
  @Nullable TI_IdentityStoreRecord getIdentityStoreRecord(String addressName);



  ArrayList<String> getAllDatabaseKeys();

  void saveIdentity(String addressName, RecipientId recipientId, IdentityKey identityKey, VerifiedStatus verifiedStatus, boolean firstUse, long timestamp, boolean nonBlockingApproval);

  void setApproval(String addressName, RecipientId recipientId, boolean nonblockingApproval);

  void setVerified(String addressName, RecipientId recipientId, IdentityKey identityKey, VerifiedStatus verifiedStatus);

  void delete(String addressName);
