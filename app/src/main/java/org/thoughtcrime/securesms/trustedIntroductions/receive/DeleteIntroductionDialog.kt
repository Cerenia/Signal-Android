...
object DeleteIntroductionDialog {
  ...
  @JvmStatic
  fun show(context: Context, introductionId: Long, introduceeName: String, introducerName: String, date: Date, f: DeleteIntroduction, g: DismissAction) {
    val builder = MaterialAlertDialogBuilder(context)
      .setTitle(R.string.DeleteIntroductionDialog__Title)

    val text = context.getString(
      R.string.DeleteIntroductionDialog__Delete_Introduction,
      introducerName,
      introduceeName,
      INTRODUCTION_DATE_PATTERN.format(date)
    )
